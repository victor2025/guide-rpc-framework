...
import com.victor2022.utils.StringUtil;
...
public final class ExtensionLoader<T> {
     ...
     * @return: T
     * @author: lihen
     * @date: 2022/8/18 20:06
     * @description: 创建key为name的扩展
     */
     ...
     * @author: lihen
     * @date: 2022/8/18 20:07
     * @description: 获取所有扩展类的类对象
     */
     ...
     * @description: 加载所有通过SPI扩展的接口对应的文件
     */
